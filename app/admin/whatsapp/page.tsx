...
export const metadata = { title: "Conversations WhatsApp — Séréna" };
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="Historique des échanges gérés par Séréna."
        accent="indigo"
      />
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
          ...
          <div className="divide-y divide-slate-100">
            {conversations.map((c) => (
              <Link
                key={c.telefono}
                href={`/admin/whatsapp/${encodeURIComponent(c.telefono)}`}
