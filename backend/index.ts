...
import adminTransferRequestsRoutes from "./routes/admin/transfer-requests";
...
import adminBoutiqueSettingsRoutes from "./routes/admin/boutique-settings";
import adminShopDangerRoutes from "./routes/admin/shop-danger";
...
app.use(adminTransferRequestsRoutes);
...
app.use(adminIntegrationsRoutes);
app.use(adminFournisseursRoutes);
app.use(adminCategoriesRoutes);
app.use(adminBoutiqueClientsRoutes);
app.use(adminBoutiqueSettingsRoutes);
app.use(adminShopDangerRoutes);
