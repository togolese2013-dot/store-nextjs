      ...
      return {
        product: {
          ...
          fields: [
            ...
            { k: "isNew",    l: "Marquer nouveau",    t: "toggle",   full: true, inlineLabel: true, hint: "" },
            ...
            { k: "discount", l: "Remise (FCFA)",       t: "price",    hint: "Si > 0 : badge promo + produit affiché dans la section Promotions du site." },
    ...
    onSubmit: async (kind, mode, values) => {
      if (kind === "product") {
        ...
        const body: Record<string, any> = {
          ...
          remise:         Number(values.discount) || 0,
          neuf:           values.isNew ? 1 : 0,
